...
#     AGENTS  : space or comma separated subset of: claude gemini copilot cursor qwen opencode windsurf codex kilocode auggie roo trae (default: all)
...
ALL_AGENTS=(claude gemini copilot cursor qwen opencode windsurf codex kilocode auggie roo trae)
ALL_SCRIPTS=(sh ps)
