...
param(
    ...
    [ValidateSet('claude','gemini','copilot','cursor','qwen','opencode','codex','windsurf','kilocode','auggie','roo','trae')]
    [string]$AgentType
)
...
function Update-SpecificAgent {
    ...
    switch ($Type) {
        ...
        default { Write-Err "Unknown agent type '$Type'"; Write-Err 'Expected: claude|gemini|copilot|cursor|qwen|opencode|codex|windsurf|kilocode|auggie|roo|trae'; return $false }
    }
}
